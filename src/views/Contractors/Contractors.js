...
import {StyledContractors, StyledContainer, StyledItem} from './ContractorsStyle'
...
export const Contractors = () => {
    return(
        <StyledContractors>
            ...
            <StyledContainer>
                {constractrorsDatas.map(item=><StyledItem key={item.id}><ContractorItem href={item.websiteLink} logoImg={item.logoImg}/></StyledItem>)}
            </StyledContainer>
        </StyledContractors>
    )
}